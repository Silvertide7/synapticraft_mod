...
public class Config {
    ...
    public static final ForgeConfigSpec.ConfigValue<Integer> MAGICAL_DAMAGE_MITIGATED_REWARD;
    ...
    static {
        ...
        MAGICAL_DAMAGE_MITIGATED_REWARD = BUILDER.defineInRange("Mitigated magic damage Xp Reward", 20, 0, Integer.MAX_VALUE);
        BUILDER.pop();
